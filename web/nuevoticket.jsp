          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card ">
                ...
                <div class="card-body ">
                  <form method="post" action="agregarticket.jsp" class="form-horizontal">
                    <div class="row">
                      <label class="col-sm-2 col-form-label">Asunto</label>
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" class="form-control" name="asunto" required="true" placeholder="Escriba el asunto del ticket...">
                        </div>
                      </div>
                    </div>

                    <div class="row">
                      <label class="col-sm-2 col-form-label">Detalle del Problema</label>
                      <div class="col-sm-10">
                        <div class="form-group">
                          <input type="text" class="form-control" name="detalleProblema" required="true" placeholder="Describa el problema...">
                        </div>
                      </div>
                    </div>

                    <div class="row">
                      <label class="col-sm-2 col-form-label label-checkbox">Prioridad</label>
                      <div class="col-sm-10 checkbox-radios">
                        <div class="form-check">
                          <label class="form-check-label">
                            <input class="form-check-input" type="radio" name="prioridad" value="alta" checked> Alta
                            <span class="circle">
                        ...
                        <div class="bootstrap-material-design">
                          <br></br>
                          <input type="button" class="btn btn-next btn-fill btn-rose btn-wd" name="submit" value="Crear">
                        </div>
                      </div>
                    </div>
                  </form>
