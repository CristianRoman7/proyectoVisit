...
<head>
  ...
  <title>
    Panel de Administrador - Visit App
  </title>
...
<body class="">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="tablesExamples">
              <ul class="nav">
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="/web/listadotickets.jsp">
                    <span class="sidebar-mini"> <i class="material-icons">person</i> </span>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="/web/nuevoticket.jsp">
                    <span class="sidebar-mini"> <i class="material-icons">person</i> </span>
              ...
              <div class="col-lg-3 col-md-6 col-sm-3">
                <div class="card card-stats">
                  <div class="card-header card-header-success card-header-icon">
                    ...
                    <p class="card-category">Abiertos</p>
                    <h3 class="card-title">7</h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">date_range</i> Ultimos 30 di璦s
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card card-stats">
                  <div class="card-header card-header-rose card-header-icon">
                    ...
                    <p class="card-category">Cerrados</p>
                    <h3 class="card-title">31</h3>
                  </div>
                  <div class="card-footer">
                    <div class="stats">
                      <i class="material-icons">date_range</i> Ultimos 30 d憝as
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script>
    ...
    // si hacemos clic en el interruptor, detenemos la propagaci贸n del evento, por lo que el men煤 desplegable no se ocultar谩, de lo contrario, configuraremos la secci贸n activa
...
// simulamos el cambio de tama帽o de la ventana para que los gr谩ficos se actualicen en tiempo real.
