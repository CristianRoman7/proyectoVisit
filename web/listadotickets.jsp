...
<body class="">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h4 class="card-title">Listado de Tickets de Soporte</h4>
                </div>
                <div class="card-body">
                  <div class="toolbar">
  ...
  <!-- Verificacion de eliminaciÃ²n de registro -->
